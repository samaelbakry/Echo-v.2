...
export default function MobileNavbar() {
  return <>
    <div className="max-w-7xl mx-auto p-2 my-2 ">
        <nav className="bg-blur dark:bg-slate-600 fixed bottom-0 left-0 w-full p-1 lg:hidden text-gray-600 dark:text-white/60 duration-500 flex items-center justify-evenly">
